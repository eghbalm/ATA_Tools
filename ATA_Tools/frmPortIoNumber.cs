...
namespace ATA_Tools
{
    public partial class frmPortIoNumber : Form
    {
        ...
        private void btnSet_Click(object sender, EventArgs e)
        {
            ...
            {
                pn.txtPort.Text = gvPorts.SelectedRows[0].Cells[0].Value.ToString();                
            }
            this.Hide();
        }
        ...
        private void gvPorts_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (gvPorts.SelectedRows.Count > 0)
            {
                pn.baseAddress = ushort.Parse(gvPorts.SelectedRows[0].Cells[0].Value.ToString(), System.Globalization.NumberStyles.HexNumber);
            }
        }
